...
public class EnemyImplTest {
	...
	public void testGetScore() {
		...
		SimpleEnemy enemy = new EnemyMockup(new SimpleMockGame(), EnemyType.DEFAULT_SHIP,
	...
	public void testPreCollided() {
		SimpleEnemy enemy = new EnemyMockup(new SimpleMockGame(), EnemyType.DEFAULT_SHIP,
				new Vector2(), new Vector2(),
				100, null, 0, 0);
		SimpleEnemy enemy2 = new EnemyMockup(new SimpleMockGame(), EnemyType.DEFAULT_SHIP,
				new Vector2(), new Vector2(),
				100, null, 0, 0);
	...
	public void testTakeDamage() {
		...
		SimpleEnemy enemy = new EnemyMockup(game, EnemyType.DEFAULT_SHIP, new Vector2(),
				new Vector2(),
				101, null, 0, 0);
	...
	public void testGetPosition() {
		...
		SimpleEnemy enemy = new EnemyMockup(new SimpleMockGame(), EnemyType.DEFAULT_SHIP, position,
				new Vector2(),
				98, null, 0, 0);
	...
	public void testIsInMyTeam() {
		SimpleEnemy enemy1 = new EnemyMockup(new SimpleMockGame(), EnemyType.DEFAULT_SHIP,
				new Vector2(), new Vector2(),
				98, null, 0, 0);

		Enemy enemy2 = new EnemyMockup(new SimpleMockGame(), EnemyType.DEFAULT_SHIP, new Vector2(),
				new Vector2(),
				87, null, 0, 0);
		...
		Enemy otherEnemy = new AnotherEnemy(new SimpleMockGame(), EnemyType.DEFAULT_SHIP,
				new Vector2(), new Vector2(),
				98, null, 0, 0);
