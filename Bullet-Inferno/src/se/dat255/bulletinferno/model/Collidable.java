 ...
 * 
 * <p>
 * preCollided/postCollided is called on two objects A, B (you cannot rely on the order) - possibly
 * multiple times - if an object might have collided. "Might have collided" means that if some
 * object in its collision handler removes a body from the world (which is OK to do), that body
...
public interface Collidable {
	 ...
	 * 
	 * <p>
	 * Useful for getting information from another body (e.g. decrease health if other not dead).
	 * 
	 * @param other
