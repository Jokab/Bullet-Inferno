...
public enum ObstacleDefinitionImpl implements ObstacleDefinition {
	...
	MOUNTAIN_1_GROUND(Arrays.asList(
			PhysicsShapeFactory.getChainShape(new Vector2[] {new Vector2(), 
				...
				new Vector2(2.65f, 4.85f), new Vector2(3.22f, 4.85f), new Vector2(3.85f, 4.57f),
				new Vector2(4.48f, 3.72f), new Vector2(5.48f, 1.54f), new Vector2(6.39f, 0.78f),
				new Vector2(7.37f, 0.64f), new Vector2(12.63f, 0.73f), new Vector2(13.8f, 1.55f),
	...
	MOUNTAIN_2_GROUND(Arrays.asList(
			PhysicsShapeFactory.getChainShape(new Vector2[] {new Vector2(0, 1.75f), 
				...
				new Vector2(4.37f, 3.53f), new Vector2(5.39f, 2.76f), new Vector2(6.52f, 2.88f),
				new Vector2(7.33f, 3.65f), new Vector2(7.37f, 4.93f), new Vector2(7.13f, 5.26f),
				new Vector2(7.88f, 5.50f), new Vector2(8.87f, 5.58f), new Vector2(9.50f, 5.26f),
				new Vector2(10.26f, 4.92f), new Vector2(10.89f, 4.96f), new Vector2(11.62f, 5.28f),
				new Vector2(11.81f, 5.13f), new Vector2(11.93f, 4.20f), new Vector2(12.21f, 3.88f),
	...
	MOUNTAIN_3_GROUND(Arrays.asList(
			...
			PhysicsShapeFactory.getChainShape(new Vector2[] {new Vector2(5.05f, 8.72f), 
				new Vector2(4.73f, 8.54f), new Vector2(4.65f,8.44f), new Vector2(4.78f, 8.08f),
				new Vector2(5.15f, 7.73f), new Vector2(5.41f, 7.55f), new Vector2(5.83f, 7.55f),
				new Vector2(6.03f, 7.61f), new Vector2(7.05f, 7.7f), new Vector2(8.02f, 7.67f),
				new Vector2(8.85f, 7.57f), new Vector2(9.67f, 7.45f), new Vector2(10.69f, 7.43f),
				new Vector2(11.83f, 7.51f), new Vector2(11.96f, 7.53f), new Vector2(11.81f, 8f),
				new Vector2(11.36f, 8.39f)
			}))), 
	MOUNTAIN_4_GROUND(Arrays.asList(
			PhysicsShapeFactory.getChainShape(new Vector2[] {new Vector2(0, 3.8f), 
				new Vector2(1.47f, 3.85f), new Vector2(3.29f, 4.38f), new Vector2(3.87f, 4.60f),
				new Vector2(4.44f, 4.67f), new Vector2(5f, 4.66f), new Vector2(5.66f, 4.52f),
				new Vector2(6.16f, 4.31f), new Vector2(6.53f, 4.06f), new Vector2(6.78f, 3.81f),
				new Vector2(6.97f, 3.48f), new Vector2(7.04f, 2.24f), new Vector2(7.16f, 2.71f),
				...
				new Vector2(10.58f, 0.72f), new Vector2(12.5f, 1.28f), new Vector2(13.56f, 1.51f),
	...
	MOUNTAIN_6_GROUND(Arrays.asList(
			PhysicsShapeFactory.getChainShape(new Vector2[] {new Vector2(0, 1.75f), 
					...
					new Vector2(12.17f, 3.27f), new Vector2(12.74f, 2.84f), new Vector2(14.11f, 2.2f),
	...
	FLOATING_ROCK(Arrays.asList(
			PhysicsShapeFactory.getChainShape(new Vector2[] { new Vector2(1.04f, 0.09f), 
					new Vector2(0.86f, 0.26f), new Vector2(0.52f, 0.52f), new Vector2(0.40f, 0.94f),
					new Vector2(0.48f, 1.05f), new Vector2(0.41f, 1.43f), new Vector2(0.43f, 1.65f),
					new Vector2(0.39f, 1.89f), new Vector2(0.71f, 1.89f), new Vector2(0.47f, 2.49f),
					...
					new Vector2(0.13f, 3.93f), new Vector2(0.18f, 4.05f), new Vector2(0.28f, 4.11f),
					new Vector2(2.66f, 4.11f), new Vector2(2.74f, 4.06f), new Vector2(2.78f, 4.01f),
					new Vector2(2.77f, 3.88f), new Vector2(2.70f, 3.74f), new Vector2(2.46f, 3.60f),
					new Vector2(2.51f, 3.22f), new Vector2(2.78f, 3.11f), new Vector2(2.67f, 2.89f),
					new Vector2(2.36f, 2.54f), new Vector2(2.24f, 2.43f), new Vector2(2.31f, 2.13f),
					new Vector2(2.38f, 1.46f), new Vector2(2.44f, 1.20f), new Vector2(2.25f, 0.76f),
					new Vector2(2.2f, 0.49f), new Vector2(1.97f, 0.31f), new Vector2(1.83f, 0.33f),
					new Vector2(1.82f, 0.17f), new Vector2(1.70f, 0.05f), new Vector2(1.54f, 0.08f),
	...
	MOUNTAIN_7_GROUND(Arrays.asList(
			PhysicsShapeFactory.getChainShape(new Vector2[] {new Vector2(16, 1.75f), 
				new Vector2(14.64f, 2f), new Vector2(12.93f,3.33f), new Vector2(12.19f, 3.63f),
				new Vector2(11.63f, 3.53f), new Vector2(10.61f, 2.76f), new Vector2(9.48f, 2.88f),
				new Vector2(8.67f, 3.65f), new Vector2(8.63f, 4.93f), new Vector2(8.87f, 5.26f),
				new Vector2(8.12f, 5.50f), new Vector2(7.13f, 5.58f), new Vector2(6.5f, 5.26f),
				new Vector2(5.74f, 4.92f), new Vector2(5.11f, 4.96f), new Vector2(4.38f, 5.28f),
				new Vector2(4.19f, 5.13f), new Vector2(4.07f, 4.20f), new Vector2(3.79f, 3.88f),
