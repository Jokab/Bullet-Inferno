...
public interface PhysicsShapeFactory {
     ...
     * 
     * <p>Please note that shapes must be properly disposed of (but the physics system will handle
     * that for you if you have used the shape with the system, e.g. in a PhysicsBodyDefinition).
     * 
